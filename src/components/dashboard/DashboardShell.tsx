...
import { BarChart3, Database, ExternalLink, FolderOpen, LogOut, Mail, Users } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 border-b border-[#DCE4DF] bg-white/95 backdrop-blur">
        <div className="flex h-16 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden rounded-full bg-[#E8F0E4] px-2.5 py-1 text-[9px] font-extrabold uppercase tracking-wider sm:inline-flex">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={() => navigate('/')}
              className="hidden items-center gap-1.5 rounded-xl border border-[#DCE4DF] px-3 py-2 text-xs font-bold text-[#40515A] transition hover:bg-[#F7F9F7] sm:inline-flex"
            >
            ...
            <button
              type="button"
              onClick={() => navigate('/')}
              className="inline-flex items-center gap-1.5 rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-xs font-bold text-red-700 transition hover:bg-red-100"
            >
