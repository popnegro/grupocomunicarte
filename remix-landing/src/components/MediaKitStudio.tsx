...
export function MediaKitStudio() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F9F7] px-4 py-6 md:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <button onClick={() => window.location.href = '/dashboard'} className="mb-3 inline-flex items-center gap-2 text-xs font-bold text-[#40515A] hover:text-[#082028]"><ArrowLeft className="h-4 w-4" /> Volver al Dashboard</button>
            ...
            <p className="mt-1 max-w-2xl text-sm text-[#64748B]">Fechas, disponibilidad, vista previa y exportación desde un único modelo comercial.</p>
          </div>
        </div>
