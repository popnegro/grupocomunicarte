...
export const DashboardHome: React.FC<DashboardHomeProps> = ({
  ...
  return (
    <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto font-sans bg-[#FAF9F5]/40 min-h-screen">
      ...
      {/* 1.5. ROADMAP DEL USUARIO (Interactive User Journey Roadmap DOOH PMV) */}
      <div className="bg-white border border border-stone-200/90 rounded-2xl p-5 md:p-6 shadow-2xs space-y-4 text-left">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-stone-100 pb-3.5">
          <div className="space-y-0.5">
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-black uppercase tracking-widest text-[#06434a] bg-[#06434a]/10 px-2 py-0.5 rounded-md">
                Roadmap de Usuario PMV
              </span>
              <span className="text-[10px] font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200/60 flex items-center gap-1">
                ...
                Flujo Comercial DOOH Activo
              </span>
            </div>
            <h3 className="text-base font-display font-black text-stone-900 tracking-tight flex items-center gap-2">
              <Compass className="h-4.5 w-4.5 text-[#06434a]" />
              Recorrido Comercial del Usuario (End-to-End DOOH Workflow)
            </h3>
          </div>
          <p className="text-xs text-stone-500 font-medium max-w-md">
            Haz clic en cualquiera de los pasos para navegar directamente al módulo correspondiente del pipeline de ventas.
          </p>
        </div>

        {/* 8-Step Interactive Roadmap Steps */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2.5 pt-1">
          {[
            {
              step: "Paso 0",
              title: "Login & Auth",
              desc: "Acceso seguro Firebase & Google",
              prio: "P0",
              tab: "home",
              icon: ShieldCheck,
              status: "Operativo",
            ...
            },
            {
              step: "Paso 1",
              title: "Diagnóstico",
              desc: "KPIs & Ocupación de red",
              prio: "P0",
              tab: "home",
              icon: TrendingUp,
              status: "En Vista",
              bg: "bg-[#06434a]/5 border-[#06434a]/30 text-[#06434a]"
            },
            {
              step: "Paso 2",
              title: "Soportes OOH",
              desc: "Inventario LED, estáticos & mapa",
              prio: "P0",
              tab: "inventario",
              icon: Tv,
              status: "Ir a módulo",
            ...
            },
            {
              step: "Paso 3",
              title: "Plan con IA",
              desc: "Sugerencias de presupuesto & ROI",
              prio: "P1",
              tab: "ai-planner",
              icon: Sparkles,
              status: "Ir a módulo",
              bg: "bg-purple-50/70 border-purple-200 text-purple-900"
            },
            {
              step: "Paso 4",
              title: "Clientes CRM",
              desc: "Gestión de agencias & propuestas",
              prio: "P0",
              tab: "clientes",
              icon: Users,
              status: "Ir a módulo",
            ...
            },
            {
              step: "Paso 5",
              title: "Workspace",
              desc: "Google Drive, Picker & Slides",
              prio: "P0",
              tab: "slides-sync",
              icon: Layers,
              status: "Ir a módulo",
            ...
            },
            {
              step: "Paso 6",
              title: "Distribución",
              desc: "PDF, Slides & Enlaces de oferta",
              prio: "P0",
              tab: "mediakit",
              icon: Share2,
              status: "Ir a módulo",
            ...
            },
            {
              step: "Paso 7",
              title: "Monitoreo",
              desc: "Pipeline, facturación & cierres",
              prio: "P0",
              tab: "admin",
              icon: DollarSign,
              status: "Ir a módulo",
            ...
            return (
              <button
                ...
                onClick={() => {
                  ...
                  triggerToast(`Navegando a ${item.step}: ${item.title}`);
                }}
                className={`p-3 rounded-xl border flex flex-col justify-between gap-2 text-left cursor-pointer transition-all hover:scale-[1.02] hover:shadow-xs group relative ${item.bg}`}
              >
                <div className="flex items-center justify-between w-full">
                  <span className="text-[9px] font-black uppercase tracking-wider opacity-75">
                    {item.step}
                  </span>
                  <span className="text-[8px] font-black px-1.5 py-0.5 rounded bg-white/80 border border-stone-200 shadow-2xs">
                    {item.prio}
                  </span>
                </div>
                <div className="space-y-0.5">
                  ...
                  <p className="text-[10px] opacity-80 leading-tight line-clamp-2">
                    {item.desc}
                  </p>
                </div>
                <div className="flex items-center justify-between text-[9px] font-black pt-1 border-t border-current/10 opacity-90 group-hover:opacity-100">
