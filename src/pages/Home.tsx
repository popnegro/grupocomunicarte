    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 pt-24 pb-32 max-w-7xl mx-auto w-full flex flex-col items-start justify-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <Link
            to="/inventario"
            className={buttonStyles({ variant: "outline", size: "lg", className: "text-lg" })}
          >
            Explorar inventario
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Link
              ...
              className="group flex flex-col items-start text-left bg-white p-10 rounded-2xl border border-gray-200 hover:border-black transition-colors shadow-sm hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
            >
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="bg-black text-white rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12 overflow-hidden relative">
          <div className="relative z-10 max-w-xl">
            ...
            <Link to="/inventario?tipo=led_movil">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-gray-100 text-center">
        ...
        <Link
          to="/inventario"
          className={buttonStyles({ size: "lg", className: "text-lg inline-flex" })}
        >
          Explorar mapa
        </Link>
      </section>
