  ...
  return (
    <div className="flex flex-col w-full">
      <section className="relative px-4 sm:px-6 lg:px-8 pt-24 pb-32 max-w-7xl mx-auto w-full flex flex-col items-start justify-center">
        <div className="inline-block px-3 py-1 mb-8 rounded-full bg-gray-100 border border-gray-200"><span className="text-xs font-semibold tracking-widest uppercase text-gray-600">Espacios Publicitarios Premium</span></div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-gray-100 text-center"><h2 className="text-3xl font-bold tracking-tight mb-4">Encontrá el soporte adecuado para tu marca</h2><p className="text-gray-600 mb-8 max-w-2xl mx-auto">Explorá nuestra cobertura geográfica y descubrí dónde están nuestros soportes.</p><Link to="/inventario" className={buttonStyles({ size: 'lg', className: 'text-lg inline-flex' })}>Explorar mapa</Link></section>
    </div>
  );
}
